...
<body>
    <nav class="navbar navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="/">Politeknik Negeri Bengkalis | D-IV Keamanan Sistem Infoasrmi</a>
        </div>
    </nav>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('postTambahBuku') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea class="form-control" name="deskripsi" placeholder="Tulis deskripsi buku di sini..." style="height: 250px;" required>{{ old('deskripsi') }}</textarea>
                            </div>
